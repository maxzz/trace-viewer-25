...
function handlePendingTimestampScroll(pendingScrollTimestamp: string | null, viewLines: readonly TraceLine[], scrollRef: React.RefObject<HTMLDivElement | null>, containerHeight: number) {
