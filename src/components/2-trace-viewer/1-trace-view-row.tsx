...
function TraceRow({ line, globalIndex, currentLineIndex, useIconsForEntryExit, showLineNumbers, uniqueThreadIds }: {
    ...
    return (
        <div className={getRowClasses(line, globalIndex, currentLineIndex)} style={{ height: ITEM_HEIGHT }} onClick={() => filesListStore.currentFileState && (filesListStore.currentFileState.currentLineIndex = globalIndex)}>
            {/* Line Number */}
            {showLineNumbers && (
